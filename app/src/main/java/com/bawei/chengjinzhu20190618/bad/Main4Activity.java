...
public class Main4Activity  extends TakePhotoActivity implements TakePhoto.TakeResultListener, InvokeListener {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        turnBtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                startActivity(new Intent(Main4Activity.this, FrameLayoutActivity.class));
            }
        });
    ...
    public void takeFail(TResult result, String msg) {
        Toast.makeText(Main4Activity.this, "Error:" + msg, Toast.LENGTH_SHORT).show();
    }
